...
file_names <- c("San Diego_estimgamma_fergen.rds",
                "Stanislaus_estimgamma_fergen.rds",
                "Contra Costa_estimgamma_fergen.rds",
                "Orange_estimgamma_fergen.rds",
                "Riverside_estimgamma_fergen.rds",
                "San Bernardino_estimgamma_fergen.rds",
                "San Francisco_estimgamma_fergen.rds",
                "Monterey_estimgamma_fergen.rds",
                "Santa Clara_estimgamma_fergen.rds",
                "Sacramento_estimgamma_fergen.rds",
                "Alameda_estimgamma_fergen.rds",
                "Merced_estimgamma_fergen.rds",
                "Fresno_estimgamma_fergen.rds",
                "Tulare_estimgamma_fergen.rds",
                "Los Angeles_estimgamma_fergen.rds")
...
write_csv(standiag_frame, "ca_county_standiags_fergen.csv")
write_rds(rt_posteriors, "ca_county_rtposteriors_fergen.rds")
write_rds(incid_posteriors, "ca_county_incidposteriors_fergen.rds")
write_rds(case_posteriors, "ca_county_caseposteriors_fergen.rds")

...
file_names <- c("San Diego_estimgamma_shorttime_sender.rds",
                "Stanislaus_estimgamma_shorttime_sender.rds",
                "Contra Costa_estimgamma_shorttime_sender.rds",
                "Orange_estimgamma_shorttime_sender.rds",
                "Riverside_estimgamma_shorttime_sender.rds",
                "San Bernardino_estimgamma_shorttime_sender.rds",
                "San Francisco_estimgamma_shorttime_sender.rds",
                "Monterey_estimgamma_shorttime_sender.rds",
                "Santa Clara_estimgamma_shorttime_sender.rds",
                "Sacramento_estimgamma_shorttime_sender.rds",
                "Alameda_estimgamma_shorttime_sender.rds",
                "Merced_estimgamma_shorttime_sender.rds",
                "Fresno_estimgamma_shorttime_sender.rds",
                "Tulare_estimgamma_shorttime_sender.rds",
                "Los Angeles_estimgamma_shorttime_sender.rds")
...
write_csv(standiag_frame, "ca_county_standiags_shorttime.csv")
write_rds(rt_posteriors, "ca_county_rtposteriors_shorttime.rds")
write_rds(incid_posteriors, "ca_county_incidposteriors_shorttime.rds")
write_rds(case_posteriors, "ca_county_caseposteriors_shorttime.rds")

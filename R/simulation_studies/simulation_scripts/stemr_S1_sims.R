...
# trying to make a dramatic test sim
# R0 goes up while testing is sparse, R0 goes down as testing increases
...
write_rds(stem_data_stochastic, "sim_stochastic_S1_1to100.rds")

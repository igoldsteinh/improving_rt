...
# using S3 data set with incorrect generation time
...
posterior <- stan(file ="R/rt_estim_gamma.stan",
                           ...
                           seed = 45, # for seed 19 we used 46
                           iter = 2000,
                           chain = 4,
                           init = init_func,
...
write_rds(res, str_c("S3_wronggen_gamma_res", seed, ".rds", ""))
